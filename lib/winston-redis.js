...
Redis.prototype.log = function (level, msg, meta, callback) {
  ...
  this.redis.llen(container, function (err, len) {
    ...
    // Set the application property in case it was configured and
    // is not included in the meta object
    if (self.application && (meta.application == null || typeof meta.application === 'undefined')) {
      meta.application = self.application;
    }

    // Set the env property in case it was configured and
    // is not included in the meta object
    if (self.env && (meta.env == null || typeof meta.env === 'undefined')) {
      meta.env = self.env;
    }
